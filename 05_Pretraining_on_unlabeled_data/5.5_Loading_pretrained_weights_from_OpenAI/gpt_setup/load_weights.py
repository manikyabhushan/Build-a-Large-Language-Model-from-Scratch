...
# accessing shift and scale params from GPT2 downloaded and assign to our GPT class
...
#  ------ Notes ------
# load_weights_into_gpt() will set the model's positional and token embedding weights
